...
const learner_hint_email = "E-posta";
...
const learner_lbl_join = "Şimdi Katıl";
const learner_lbl_don_t_joined_yet = "Hala Aramıza Katılmadın mı !";
...
const learner_lbl_My_Courses = "İlerleme Durumum";
const learner_lbl_All = "All";
const learner_lbl_Ongoing = "Ongoing";
const learner_lbl_Completed = "Completed";
const learner_lbl_project_management = "Derse Hakkında";
const learner_lbl_30_80 = "İş Fırsatlarını Yakala";
const learner_lbl_1_6k = "300";
const learner_lbl_students = "Öğrenci";
const learner_lbl_rating = "Başarı Oranı";
const learner_lbl_37 = "15";
const learner_lbl_lectures = "Ders Sayısı";
const learner_lbl_5_0 = "3.7";
const learner_lbl_swipe_up_to_show_course_contents = "Kursiyer Yorumları";
const learner_lbl_hannah_tran = "Eğitmen Atıl Samancıoğlu";
